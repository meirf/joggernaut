...
def get_coordinates():
    """
    Read from kml file the coordinates and node ids.
    """
...
def get_all_elevations():
    ...
    elevs = [ 8.772932052612305, 8.630032539367676, 8.481337547302246, 8.473003387451172, 8.605457305908203,
             8.851371765136719, 9.326964378356934, 9.620454788208008, 10.08272743225098, 11.16177463531494,
             11.96563720703125, 12.13568782806396, 12.42085742950439, 12.87494850158691, 8.372590065002441,
             8.12594985961914, 8.07753849029541, 8.126249313354492, 8.17297649383545, 8.269344329833984,
             8.467561721801758, 8.599291801452637, 8.693227767944336, 9.083831787109375, 9.349800109863281,
             9.437838554382324, 9.580528259277344, 9.914894104003906, 8.121710777282715, 7.835072040557861,
             7.691619873046875, 7.598601818084717, 7.615684509277344, 7.728802680969238, 7.702752113342285,
             7.725890636444092, 7.606010437011719, 7.569760322570801, 7.693739414215088, 7.730432987213135,
             7.644207000732422, 7.592205047607422, None, 7.205403804779053, 7.732362747192383, 8.290694236755371,
             7.37311649323, 7.17826652527, 6.80265760422, 6.78662490845, 7.14887714386, 8.43306159973, 8.35956192017,
             8.1632232666, 7.93828582764, 7.62221002579, 7.09258747101, 5.68282175064, 7.37508964539]
...
def get_elevation(coord_pair_long_lat):
    """
    Retrieves elevation data from Google API
    """
...
def get_adj_list():
    """
    Sets up adjacency list of graph
    """
    coords = get_coordinates()
